...
parser.add_argument(
    "--num_beam_groups", type=int, default=3, help="number of beam groups"
)
parser.add_argument(
    "--min_len", type=int, default=10, help="the minimum length of an explanation"
)
parser.add_argument(
...
with open(os.path.join(args.data_dir, "datamaps.json"), "r") as f:
    datamaps = json.load(f)
exp_iterator = ExpBatchify(
    exp_corpus.test, datamaps["user2id"], tokenizer, args.exp_len, args.batch_size
)
